...
<div class="grid grid-cols-4 px-20 my-10 gap-10">
    ...
    <div class="col-span-2 px-4 border-x">
        <h1 class="text-4xl font-bold text-blue-700">{{$product->name}}</h1>
        ...
        <button type="submit" class="bg-gradient-to-r from-red-700 via-yellow-400 to-gray-700 text-white px-3
        py-1.5 rounded-lg mt-4 inline-block">Add to Cart</button>
    </form>
     </div>
     <div>
     <p>Free Delivery</p>
