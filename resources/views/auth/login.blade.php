...
<body>
      <div class="grid grid-cols-2">
        <img src="https://bitmapitsolution.com/images/login/login.jpg" alt=""
        class="h-screen w-full border-r">
        <div class="flex items-center justify-center">
            <div class="text-center w-6/12">
                ...
                <form action="{{route('login')}}" method="POST" class="mt-5">
                    ...
                    class="block w-full p-3 rounded-lg border border-gray-300 mb-3">
                    @error('email')
